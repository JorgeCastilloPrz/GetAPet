...
import jorgecastilloprz.github.io.getapet.common.view.picasso.CircleTransform
...
class PetDetailActivity : AppCompatActivity() {
  ...
  private fun loadAvatarPicture() {
    val url = "https://images.pexels.com/photos/614810/pexels-photo-614810.jpeg?cs=srgb&dl=face-facial-hair-fine-looking-614810.jpg&fm=jpg"
    Picasso.get()
        .load(url)
